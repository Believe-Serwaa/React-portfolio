  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 bg-gray-900">
      ...
      <section id="experience" className="mb-16">
        <motion.h2
          className="text-3xl sm:text-4xl font-bold text-center mb-10 text-blue-400"
        ...
        >
          <span className="inline-block relative">
            Working Experience
            <motion.div 
              className="absolute -bottom-2 left-0 right-0 h-1 bg-blue-400"
              initial={{ width: 0 }}
          ...
          {[
            ...
            >
              ...
              <div className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-500 p-4 ml-2 hover:ml-4 transform hover:-translate-y-1 w-full">
                ...
                <h4 className="text-gray-700 text-sm font-medium mb-2">{job.company}</h4>
          ...
          {[
            ...
            >
              ...
              <div className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-500 p-4 ml-2 hover:ml-4 transform hover:-translate-y-1 w-full">
                ...
                <h4 className="text-gray-700 text-sm font-medium mb-2">{edu.school}</h4>
                <p className="text-gray-600 text-sm mb-2 line-clamp-2">{edu.description}</p>
